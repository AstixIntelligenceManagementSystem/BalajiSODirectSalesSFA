...
public class CommonInfo
{
	...
	/*public static final String DistributorMapXMLFolder="BalajiSOSFADistributorMapXML";
	public static final String DistributorStockXMLFolder="BalajiSOSFADistributorStockXML";
	public static final String DistributorCheckInXMLFolder="BalajiSOSFADistributorCheckInXML";
	public static final String Preference="BalajiSOSFAPrefrence";
	...
	public static String VersionDownloadAPKName="BalajiSOSFA.apk";
...
*/
	...
	public static String VersionDownloadPath="http://103.20.212.194/downloads/";
	public static String VersionDownloadAPKName="BalajiSODirectSalesSFADev.apk";
	...
	public static String OrderSyncPath="http://103.20.212.194/ReadXML_BalajiDevelopment/DefaultSOSFA.aspx";
	public static String ImageSyncPath="http://103.20.212.194/ReadXML_BalajiImagesDevelopment/Default.aspx";
	public static String OrderTextSyncPath="http://103.20.212.194/ReadTxtFileForBalajiSFADevelopment/default.aspx";
	...
	public static String OrderSyncPathWarehouseMap="http://103.20.212.194/ReadXML_BalajiDevelopment/DefaultSOWarehouseMapping.aspx";
	...
	public static String WebDSRAttendanceUrl="http://103.20.212.194/Balaji_dev/Reports/frmDSRAttendanceReport.aspx";
	public static String OrderXMLFolder="BalajiSOSFAXml";
	public static String ImagesFolder="BalajiSOSFAImages";
	public static String TextFileFolder="BalajiSOSFATextFile";
	public static String InvoiceXMLFolder="BalajiSOSFAInvoiceXml";
	...
	public static final String AttandancePreference="BalajiSOSFAAttandancePreference";
	public static int DistanceRange=3000;
	public static String SalesPersonTodaysTargetMsg="";
	public static int CoverageAreaNodeID=0;
	public static int CoverageAreaNodeType=0;
	...
	public static String ActiveRouteSM="0";
	public static int DayStartClick=0;
	public static String ImagesFolderServer="BalajiSOSFAImagesServer";
	public static int PersonNodeID=0;
	public static int PersonNodeType=0;
	public static int flgSOOnlineOffLine=0;
	public static String OrderSyncPathSO="http://103.20.212.194/ReadXML_BalajiDevelopment/DefaultSO.aspx";
	public static String URLImageLinkToViewStoreOverWebProtal="http://103.20.212.194/Balaji_dev/Reports/frmPDAImgsDev.aspx";
	public static int flgNewStoreORStoreValidation=0;
	public static String WebPageUrlDSMWiseReport="http://103.20.212.194/Balaji_dev/Mobile/frmDSMWiseReportCard.aspx?imei=";
	public static String WebPageUrlDataReport="http://103.20.212.194/Balaji_dev/Mobile/fnSalesmanWiseSummaryRpt.aspx";
	public static String WebPageUrl="http://103.20.212.194/Balaji_dev/Mobile/frmRouteTracking.aspx";
