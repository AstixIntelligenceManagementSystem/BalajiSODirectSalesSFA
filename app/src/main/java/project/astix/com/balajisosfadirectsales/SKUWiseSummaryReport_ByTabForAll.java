...
public class SKUWiseSummaryReport_ByTabForAll extends Activity
{
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId())
        {
            case android.R.id.home:
                ...
                Intent ide=new Intent(SKUWiseSummaryReport_ByTabForAll.this,DetailReportSummaryActivityForAll.class);
